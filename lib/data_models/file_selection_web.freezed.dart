...
mixin _$FileSelection {
  ...
  @StreamConverter()
  Stream<List<int>>? get readStream => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      bytes: freezed == bytes
          ...
          : bytes // ignore: cast_nullable_to_non_nullable
              as Uint8List?,
      readStream: freezed == readStream
          ? _value.readStream
          : readStream // ignore: cast_nullable_to_non_nullable
              as Stream<List<int>>?,
    ) as $Val);
  }
}
...
class _$FileSelectionImpl extends _FileSelection {
  _$FileSelectionImpl(
      ...
      @StreamConverter() this.readStream})
      : super._();
  ...
  @override
  String toString() {
    return 'FileSelection(id: $id, name: $name, size: $size, path: $path, bytes: $bytes, readStream: $readStream)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.readStream, readStream) ||
  ...
  int get hashCode => Object.hash(runtimeType, id, name, size, path,
      const DeepCollectionEquality().hash(bytes), readStream);
...
abstract class _FileSelection extends FileSelection {
  factory _FileSelection(
          ...
          @StreamConverter() final Stream<List<int>>? readStream}) =
      _$FileSelectionImpl;
